...
export default function DoctorAppointmentsList({ appointments, userRole, user }) {
  ...
  // Use the appointments from props if available, otherwise use the fetched data
  const appointmentsList = appointments?.length > 0 ? appointments : (data?.appointments || []);
